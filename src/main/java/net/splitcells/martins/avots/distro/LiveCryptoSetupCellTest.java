...
public class LiveCryptoSetupCellTest {
    @UnitTest public void test() {
        testSerializeConfiguration(LiveCryptoSetupCell.class, """
                * Configuration Serialization:
                    ...
                    * net.splitcells.dem.environment.config.ProgramLocalIdentity: class net.splitcells.martins.avots.distro.LiveCryptoSetupCell
                    * net.splitcells.dem.environment.config.ProgramName: net.splitcells.martins.avots.distro.LiveCryptoSetupCell
                    * net.splitcells.dem.environment.config.ProgramRepresentative: net.splitcells.martins.avots.distro.LiveCryptoSetupCell
                    ...
                    * net.splitcells.martins.avots.distro.LiveCryptoSetupCell: net.splitcells.martins.avots.distro.LiveDistroCell
                    ...
                    * net.splitcells.network.distro.java.acme.AcmeServerUri: https://acme-v02.api.letsencrypt.org/directory
